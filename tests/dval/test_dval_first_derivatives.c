...
{
    RUN_SUBTEST(test_deriv_const);
    RUN_SUBTEST(test_deriv_var);
    RUN_SUBTEST(test_deriv_wrt_const_is_nan);
    RUN_SUBTEST(test_deriv_neg);
    RUN_SUBTEST(test_deriv_add_d);
    RUN_SUBTEST(test_deriv_mul_d);
    RUN_SUBTEST(test_deriv_div_d);
    RUN_SUBTEST(test_deriv_x2);
    RUN_SUBTEST(test_deriv_pow3);
    RUN_SUBTEST(test_deriv_pow_xy);
    RUN_SUBTEST(test_deriv_sin);
    RUN_SUBTEST(test_deriv_cos);
    RUN_SUBTEST(test_deriv_tan);
    RUN_SUBTEST(test_deriv_sinh);
    RUN_SUBTEST(test_deriv_cosh);
    RUN_SUBTEST(test_deriv_tanh);
    RUN_SUBTEST(test_deriv_asin);
    RUN_SUBTEST(test_deriv_acos);
    RUN_SUBTEST(test_deriv_atan);
    RUN_SUBTEST(test_deriv_atan2);
    RUN_SUBTEST(test_deriv_asinh);
    RUN_SUBTEST(test_deriv_acosh);
    ...
    RUN_SUBTEST(test_deriv_exp_tanh);
    RUN_SUBTEST(test_deriv_sqrt_sin_x2);
    RUN_SUBTEST(test_deriv_log_cosh);
    RUN_SUBTEST(test_deriv_x2_exp_negx);
    RUN_SUBTEST(test_deriv_atan_x_over_sqrt);
    RUN_SUBTEST(test_deriv_abs);
    RUN_SUBTEST(test_deriv_hypot);
    RUN_SUBTEST(test_deriv_erf);
    RUN_SUBTEST(test_deriv_erfc);
    RUN_SUBTEST(test_deriv_erfinv);
    RUN_SUBTEST(test_deriv_erfcinv);
    ...
    RUN_SUBTEST(test_deriv_normal_pdf);
    RUN_SUBTEST(test_deriv_normal_cdf);
    RUN_SUBTEST(test_deriv_normal_logpdf);
    RUN_SUBTEST(test_deriv_ei);
    RUN_SUBTEST(test_deriv_e1);
    RUN_SUBTEST(test_deriv_beta);
    RUN_SUBTEST(test_deriv_logbeta);
}
