...
/// @return the address of the initialised datetime.
datetime_t *datetime_init_ymdt(datetime_t *self, short year, month_t month, uint8_t day, uint8_t hour, uint8_t minute, double second);
...
bool datetime_equal(const datetime_t *dt1, const datetime_t *dt2);
...
datetime_t *datetime_init_sunrise(datetime_t *self, long julianDayNumber, double latitude, double longitude, double timeZoneOffset);
...
///         (e.g. polar night), the time components of the datetime object will be set to 0, and the function will return the 
///         datetime object with the date set to the given Julian Day Number.
datetime_t *datetime_init_sunset(datetime_t *self, long julianDayNumber, double latitude, double longitude, double timeZoneOffset);
...
/// @param longitude the longitude of the location to calculate the sunrise time for.
/// @param timeZoneOffset the time zone offset in hours to adjust the calculated time to local time.
void datetime_set_sunrise(datetime_t *self, double latitude, double longitude, double timeZoneOffset);
...
/// @param longitude the longitude of the location to calculate the sunset time for.
/// @param timeZoneOffset the time zone offset in hours to adjust the calculated time to local time.
void datetime_set_sunset(datetime_t *self, double latitude, double longitude, double timeZoneOffset);
