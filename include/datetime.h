...
bool datetime_isEqual(const datetime_t *dt1, const datetime_t *dt2);
...
bool datetime_isLeapYear(short year);
...
///        datetime_initWithSunsetSunriseTime() that calls it with the isSunrise parameter set to true to calculate the sunrise time.
...
datetime_t *datetime_initWithSunriseTime(datetime_t *self, long julianDayNumber, double latitude, double longitude, double timeZoneOffset);

/// @brief initialise a datetime object with the sunset time for a given date and location. This function is a wrapper around
///        datetime_initWithSunsetSunriseTime() that calls it with the isSunrise parameter set to false to calculate the sunset time.
...
///         (e.g. polar night), the time components of the datetime object will be set to 0, and the function will return the 
///         datetime object with the date set to the given Julian Day Number.
datetime_t *datetime_initWithSunsetTime(datetime_t *self, long julianDayNumber, double latitude, double longitude, double timeZoneOffset);
...
///        wrapper around datetime_setToSunriseSunsetTime() that calls it with the isSunrise parameter set to true. The location is 
...
/// @param longitude the longitude of the location to calculate the sunrise time for.
/// @param timeZoneOffset the time zone offset in hours to adjust the calculated time to local time.
void datetime_setToSunriseTime(datetime_t *self, double latitude, double longitude, double timeZoneOffset);
...
///        wrapper around datetime_setToSunriseSunsetTime() that calls it with the isSunrise parameter set to false. The location is 
///        specified by the latitude and longitude. The time zone offset is used to adjust the calculated time to the local time zone.
/// @param self the datetime object to set the time components of.
/// @param latitude the latitude of the location to calculate the sunset time for.
/// @param longitude the longitude of the location to calculate the sunset time for.
/// @param timeZoneOffset the time zone offset in hours to adjust the calculated time to local time.
void datetime_setToSunsetTime(datetime_t *self, double latitude, double longitude, double timeZoneOffset);
...
///        object, and then uses that Julian Day Number to calculate the moon phase using the datetime_moonPhaseOnJulianDayNumber()
