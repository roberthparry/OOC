...
|---|---:|---:|---:|---:|
| `mc_exp(0.567 + 0.321i)` | `96.958 ms` | `77.312 ms` | `94.131 ms` | `143.079 ms` |
| `mc_log(0.567 + 0.321i)` | `5.937 ms` | `15.091 ms` | `20.302 ms` | `33.969 ms` |
| `mc_sqrt(0.567 + 0.321i)` | `0.546 ms` | `0.591 ms` | `0.576 ms` | `0.614 ms` |
...
| `mc_sin(0.567 + 0.321i)` | `425.379 ms` | `348.170 ms` | `1259.126 ms` | `969.273 ms` |
...
| `mc_asin(0.321 + 0.123i)` | `3801.397 ms` | `6530.940 ms` | `7533.667 ms` | `8872.427 ms` |
| `mc_acos(0.321 + 0.123i)` | `8741.862 ms` | `8872.539 ms` | `13779.907 ms` | `20992.047 ms` |
...
| `mc_asinh(0.321 + 0.123i)` | `4116.472 ms` | `4265.139 ms` | `4881.334 ms` | `6543.134 ms` |
| `mc_acosh(2 + 0.5i)` | `3090.247 ms` | `4561.408 ms` | `5970.427 ms` | `12457.722 ms` |
