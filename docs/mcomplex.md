...
| `mc_sqrt(0.567 + 0.321i)` | `0.153 ms` | `0.167 ms` | `0.184 ms` | `0.188 ms` |
...
| `mc_asin(0.321 + 0.123i)` | `2596.578 ms` | `4579.910 ms` | `4831.958 ms` | `5130.255 ms` |
| `mc_acos(0.321 + 0.123i)` | `10386.421 ms` | `8938.546 ms` | `14968.080 ms` | `21584.852 ms` |
